...
import SectionProductsDiscount from "./SectionProductsDiscount";
...
export default function SectionProducts() {
  ...
  return (
    <section className="max-w-screen-lg mx-auto py-16 space-y-8" id="products">
      <div className="grid md:grid-cols-2 place-items-center sm:px-5 px-1 max-md:text-center gap-6">
        <SectionProductsIntro />
        <SectionProductsDiscount />
      </div>
...
export function SectionProductsIntro() {
  return (
    <div className="space-y-2 px-5 text-balance">
